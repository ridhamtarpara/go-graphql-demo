...
func (l *UserLoader) Load(key int) (*api.User, error) {
...
func (l *UserLoader) LoadThunk(key int) func() (*api.User, error) {
	l.mu.Lock()
	if it, ok := l.cache[key]; ok {
		l.mu.Unlock()
		return func() (*api.User, error) {
			return it, nil
		}
	}
	if l.batch == nil {
...
func (l *UserLoader) LoadAll(keys []int) ([]*api.User, []error) {
	results := make([]func() (*api.User, error), len(keys))
...
func (l *UserLoader) Prime(key int, value *api.User) bool {
	l.mu.Lock()
	var found bool
...
func (l *UserLoader) unsafeSet(key int, value *api.User) {
	if l.cache == nil {
		l.cache = map[int]*api.User{}
	}
	l.cache[key] = value
}
